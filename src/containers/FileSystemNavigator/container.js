...
import { actions as actionsPagesDashboard, name as namePagesDashboard } from "../../store/pages/dashboard";
import { actions as actionsFileSystemNavigator, name as nameFileSystemNavigator } from "../../store/containers/fileSystemNavigator";
